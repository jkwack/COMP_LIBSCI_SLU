...
/* 
 * updated to solve a CSR matrix
 * National Center for Supercomputing Applications, JaeHyuk Kwack
 * March 20, 2017
 */
...
void
c_fortran_dgssv_transposed_(int *iopt, int *n, int *nnz, int *nrhs,
 ...
 */
	...
	*f_factors = (fptr) LUfactors;
	...
	fprintf(stderr,"Invalid iopt=%d passed to c_fortran_dgssv_transposed()\n",*iopt);
	exit(-1);
    }
}
